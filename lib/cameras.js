...
export const CAMERAS = [
    { id: 73, name: '福田东', locationId: '101280603', description: '朝东俯瞰福田区东侧和远方罗湖区，画面右侧河对岸是香港，本视角可观测日出方向天色变化' },
    { id: 78, name: '福田西', locationId: '101280603', description: '朝西俯瞰福田区西侧，下方草地是香蜜湖，画面远处为南山区，左侧是深圳湾，本视角可观测日落方向云彩' },
    { id: 75, name: '福田南', locationId: '101280603', description: '朝南俯瞰福田南部及深港边界，视野开阔' },
    { id: 80, name: '福田北', locationId: '101280603', description: '朝北俯瞰福田北部，下方为莲花山公园，远处左侧可见梅林山，右侧为银湖山' },
    { id: 106, name: '罗湖东北', locationId: '101280602', description: '俯瞰罗湖东北方向，可观测梧桐山山脉云雾，画面左下角为洪湖公园' },
    { id: 102, name: '罗湖西南', locationId: '101280602', description: '俯瞰罗湖西南方向，可观测福田和南山市区全貌，画面左下方为深圳河' },
    { id: 100, name: '蛇口码头', timeSuffix: 8, locationId: '101280604', description: '俯瞰蛇口港和深圳湾，对面为香港元朗区，可观测海面天气与能见度' },
    { id: 105, name: '求雨坛南', locationId: '101280605', description: '山顶东南向全景，可观测沈海告诉和铁岗水库' },
    { id: 62, name: '石岩梯度塔全景', locationId: '101280605', description: '石岩梯度塔全景，可观测西北方向大气层结变化' },
    // { id: 309, name: '石岩观测场', timeSuffix: 8, locationId: '101280605', description: '石岩气象观测场，可观测西北方向大气层结变化' },
    { id: 702, name: '大运中心东南', locationId: '101280606', description: '俯瞰大运中心东南方向，可观测龙岗区天气，远处为马峦山' },
    { id: 46, name: '西涌南', locationId: '101280609', description: '朝南俯瞰西涌海湾，可观测南海水天一色' },
    { id: 502, name: '西涌东', locationId: '101280609', description: '朝东俯瞰西涌东海岸，可观测日出及海面天气' }
];
